...
public class FormContent extends JPanel {
    ...
    protected JButton Them,Sua,Xoa,LamMoi,ChiTiet,XuatExcel,Luu,Thoat,NhapExcel;
    //Font button
    protected final Font font=new Font("Segoe UI", 0, 14);
    //Màu button
    protected final Color background=Color.decode("#90CAF9");
    protected final Border border=BorderFactory.createLineBorder(background, 1);
