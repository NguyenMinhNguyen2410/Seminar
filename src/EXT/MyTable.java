...
public class MyTable extends JPanel {
    ...
    public void addRow(TagDTO data) {
        addRow(new String[]{
                    data.getTag_id(),
                    data.getProduct_id(),
                    data.getTag_gate_in(),
                    String.valueOf(data.getTag_date_in()),
                    data.getTag_gate_out(),
                    String.valueOf(data.getTag_date_out())
                });
    }
    public void addRow(ProductDTO data) {
        addRow(new String[]{
                data.getProduct_id(),
                data.getProduct_name(),
                String.valueOf(data.getProduct_quantity()),
                data.getProduct_detail()
        });
    }
    public void addRow(OrderProductDTO data) {
        addRow(new String[]{
                data.getOrder_id(),
                String.valueOf(data.getOrder_date()),
                String.valueOf(data.getStatus())
        });
    }
    public void addRow(OrderDetailDTO data) {
        addRow(new String[]{
                data.getOrder_detail_id(),
                data.getOrder_id(),
                data.getProduct_id(),
                String.valueOf(data.getProduct_quantity())
        });
